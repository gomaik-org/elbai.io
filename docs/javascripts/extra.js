...
(function () {
  ...
  function openLightbox(element) {
    ...
    svgs.forEach((svg, idx) => {
      ...
      // Preserve viewBox and aspect ratio from original SVG
      if (originalSvgs[idx]) {
        const origViewBox = originalSvgs[idx].getAttribute('viewBox');
        if (origViewBox && !svg.getAttribute('viewBox')) {
